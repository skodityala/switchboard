...
const {
  RESTRICTION_ORDER, rank, NEVER_DISCLOSABLE, keyOf, effectiveOf, evaluate, adjudicate, refOf, SnapshotGraph, traceIsHonest, normaliseForComparison
} = (() => {
/**
...
//# sourceMappingURL=core.js.map
  return { RESTRICTION_ORDER, rank, NEVER_DISCLOSABLE, keyOf, effectiveOf, evaluate, adjudicate, refOf, SnapshotGraph, traceIsHonest, normaliseForComparison };
})();
...
// ── packages/reasoner/dist/turn.js ─────────────────────────────────────────────
const {
...
function refusalFor(trace) {
    const secure = trace.effectiveClassification === 'PHI' ||
 ...
 */
async function runTurn(utterance, state, catalog, intent, startedMicros) {
    ...
    let escalated = false;
    if (denied) {
        reply = refusalFor(traces.find((t) => t.decision === 'DENY'));
    }
    else {
...
//# sourceMappingURL=turn.js.map
  return { INTENT_FIELDS, TEMPLATES, refusalFor, runTurn };
})();
...
//# sourceMappingURL=deterministic.js.map
  return { normalize, DeterministicReasoner };
})();
